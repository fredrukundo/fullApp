...
const Informations = () => {
  const { authState, LogedInUser } = useContext(AuthContext);
      ...
      <View style={[styles.container,{backgroundColor:activeColors.bgcolor}]}>
        ...
        <ScrollView>
          ...
          <View style={[styles.detailBox,{backgroundColor:activeColors.bgcolor}]}>
             ...
             <View>
             <TouchableOpacity style={styles.header} onPress={()=> navigation.navigate('User profile details', {id:LogedInUser.attributes.sub})}>
